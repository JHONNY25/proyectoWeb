...
$coment = new Paginacion();
    ...
    $comentario = $coments->getComentariosLimitAlumno();

    $conteo = $coment->getNumeroComentariosAlumno();
    ...
    $contenido = '<a class="nav-link dropdown-toggle d-flex" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        $contenido .=   '<a class="dropdown-item d-block align-items-center viewComents" href="#" id="'.$row['id_usuario'].'">
                <div class="">
